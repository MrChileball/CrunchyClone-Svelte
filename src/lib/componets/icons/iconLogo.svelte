        <svg xmlns="http://www.w3.org/2000/svg" class="icon-logo-mobile logo-icon" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 48 48">
...
<style>
    ...
    .logo-icon path{ 
        fill: var(--custom-light-coral);
        transition: all 0.1s ease-in;
    }

    .icon-logo-mobile{
    width: clamp(1.1em, 1.2em + 2vw, 4em);
    height: auto;
    
    }
    .icon-logo-desktop{
        width: clamp(4em, 9em + 1.6vw, 12em);
        height: auto;
        display: none;
        transition: all var(--custom-transition-03s) ease;
    }
    .icon-logo-mobile:hover,
    .icon-logo-desktop:hover{
